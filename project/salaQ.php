...
<html>
  ...
  <body>
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="indexlog.php"><img class="favicon" src="multimedia/favicon.png">  ¡Yeah English Yeah! - Quices</a>
        <div class="container">
                ...
                <div class="col-xs-12 col-lg-8 py-5">
                    <div class="card border-0 shadow my-5">
                        <div class="card-body p-5">
                            ...
                            <a href="exam1.html" class="btn btn-primary">iniciar ahora</a>
                        </div>
                    </div>
                </div>
